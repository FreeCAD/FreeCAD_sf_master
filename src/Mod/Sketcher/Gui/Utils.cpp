...
bool SketcherGui::isCommandActive(Gui::Document* doc,
                                  bool actsOnSelection,
                                  bool needsGeom,
                                  bool needsBSpline,
                                  bool needsNotOnlyBspline,
                                  bool needsNotOnlyElipse,
                                  bool needsNotOnlyPoint,
                                  bool needsConstraint)
{
    ...
    if (isSketchInEdit(doc)) {
        ...
        if (mode == ViewProviderSketch::STATUS_NONE
            ...
            return !(needsGeom && !selectionHasGeo) && !(needsBSpline && !selectionHasBSpline)
